...
Revision ID: 9cf9e5b93805
Revises: 
Create Date: 2023-01-25 19:18:28.967016
...
def upgrade():
    ...
    sa.Column('body_style', sa.String(length=150), nullable=True),
    sa.Column('value', sa.NUMERIC(precision=10, scale=2), nullable=True),
    sa.Column('color', sa.String(length=150), nullable=True),
    sa.Column('seating', sa.NUMERIC(precision=3, scale=0), nullable=True),
